...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = blue_teeth_Pin|blue_teethA1_Pin;
  ...
  /* USER CODE END USART2_MspInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = wht101_Pin|wht101D6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART3_MspInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = openmv_Pin|openmvD9_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  /* USER CODE END USART6_MspInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    GPIO_InitStruct.Pin = jy901_Pin|jy901C7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, blue_teeth_Pin|blue_teethA1_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, wht101_Pin|wht101D6_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, openmv_Pin|openmvD9_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC7     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOC, jy901_Pin|jy901C7_Pin);
